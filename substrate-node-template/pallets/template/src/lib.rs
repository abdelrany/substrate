...
pub mod pallet {
	...
	// Action #1 - Configure the pallet to emit events
	...
	// Action #2 - Implement pallet events
	...
	// Action #3 - Include pallet errors
	#[pallet::error]
	pub enum Error<T> {
	...
	// Action #4 - Implement a storage map for stored items
	#[pallet::storage]
	...
	pub(super) type Proofs<T: Config> = StorageMap<
		...
		OptionQuery,
	>;
	// Action #5 - Implement callable functions
